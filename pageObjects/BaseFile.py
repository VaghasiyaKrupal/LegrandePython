...
class CommanFlow:
    ...
    def CreatePatient(self):
        ...
        if "Congratulations, you have successfully created a new Patient Account." in self.driver.page_source:
            ...
            loginSheet.cell(8, 3).value = EmailAddress.lower()
    ...
    def OnetimeRXSkipPayment(self):
        ...
        time.sleep(3)
        Product = self.driver.find_element_by_xpath("//*[text()='" + datasheet.cell(2, 5).value + "']")
        Product.click()
        ...
        allergies.clear()
        allergies.send_keys(datasheet.cell(2, 9).value)
        ...
        self.driver.find_element_by_xpath(Locators.pharmacyNotes).send_keys(datasheet.cell(2, 10).value)
    ...
    def OnetimeRXProvidePayment(self):
        ...
        addressZipcode.send_keys(datasheet.cell(2, 21).value)
        ...
        notes.clear()
        notes.send_keys(datasheet.cell(2, 10).value)
        self.driver.find_element_by_xpath(Locators.submit_CreateOrderButton).click()
        time.sleep(7)
    ...
    def OnetimeOTCProvidePayment(self):
        ...
        DoctorSearch = self.driver.find_element_by_xpath(Locators.doctor_search_textbox)
        DoctorSearch.click()
        DoctorSearch.send_keys(datasheet.cell(2, 3).value)
        self.driver.find_element_by_xpath("(//*[text()='" + datasheet.cell(2, 3).value + " " + "Practice'])[2]").click()
        self.driver.find_element_by_xpath(Locators.NextButton).click()
        self.driver.find_element_by_xpath(Locators.CreateOnetimeRXButton).click()
        self.driver.find_element_by_name(Locators.OnetimeSearchMedicine).click()
        time.sleep(3)
        ...
        cardNumber.clear()
        cardNumber.send_keys(datasheet.cell(2, 13).value)
